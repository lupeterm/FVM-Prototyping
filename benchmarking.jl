...
cases = [
    ("cases/Lid-Driven-Cavities/$(i*20)", "LDC-$(i*20)", "Lid-Driven-Cavity $(i*20)") for i in 1:5
]
struct Result
...
function bench_gpu(i=nothing, T=Float64, case_short="")
    suite = BenchmarkGroup()
    ...
    # for (case_path, case_short, case_long) in cases
        ...
        # suite["gpu"][case_short]["CellBased"]["WG32-8192"] = @benchmarkable CellBased($cellinput, $pde, $32, $8192)
        # suite["gpu"][case_short]["CellBased"]["WG64-8192"] = @benchmarkable CellBased($cellinput, $pde, $64, $8192)
        # suite["gpu"][case_short]["CellBased"]["WG128-8192"] = @benchmarkable CellBased($cellinput, $pde, $128, $8192)
        # suite["gpu"][case_short]["CellBased"]["WG512-8192"] = @benchmarkable CellBased($cellinput, $pde, $512, $8192)
        # suite["gpu"][case_short]["CellBased"]["WG32-16384"] = @benchmarkable CellBased($cellinput, $pde, $32, $16384)
        # suite["gpu"][case_short]["CellBased"]["WG64-16384"] = @benchmarkable CellBased($cellinput, $pde, $64, $16384)
        # suite["gpu"][case_short]["CellBased"]["WG128-16384"] = @benchmarkable CellBased($cellinput, $pde, $128, $16384)
        # suite["gpu"][case_short]["CellBased"]["WG512-16384"] = @benchmarkable CellBased($cellinput, $pde, $512, $16384)
        # suite["gpu"][case_short]["CellBased"]["WG32-32768"] = @benchmarkable CellBased($cellinput, $pde, $32, $32768)
        # suite["gpu"][case_short]["CellBased"]["WG64-32768"] = @benchmarkable CellBased($cellinput, $pde, $64, $32768)
        # suite["gpu"][case_short]["CellBased"]["WG128-32768"] = @benchmarkable CellBased($cellinput, $pde, $128, $32768)
        # suite["gpu"][case_short]["CellBased"]["WG512-32768"] = @benchmarkable CellBased($cellinput, $pde, $512, $32768)
        # suite["gpu"][case_short]["CellBased"]["WG32-65536"] = @benchmarkable CellBased($cellinput, $pde, $32, $65536)
        # suite["gpu"][case_short]["CellBased"]["WG64-65536"] = @benchmarkable CellBased($cellinput, $pde, $64, $65536)
        # suite["gpu"][case_short]["CellBased"]["WG128-65536"] = @benchmarkable CellBased($cellinput, $pde, $128, $65536)
        # suite["gpu"][case_short]["CellBased"]["WG512-65536"] = @benchmarkable CellBased($cellinput, $pde, $512, $65536)
        # suite["gpu"][case_short]["CellBased"]["WG32-131072"] = @benchmarkable CellBased($cellinput, $pde, $32, $131072)
        # suite["gpu"][case_short]["CellBased"]["WG64-131072"] = @benchmarkable CellBased($cellinput, $pde, $64, $131072)
        # suite["gpu"][case_short]["CellBased"]["WG128-131072"] = @benchmarkable CellBased($cellinput, $pde, $128, $131072)
        # suite["gpu"][case_short]["CellBased"]["WG512-131072"] = @benchmarkable CellBased($cellinput, $pde, $512, $131072)
        # suite["gpu"][case_short]["CellBased"]["WG32-262144"] = @benchmarkable CellBased($cellinput, $pde, $32, $262144)
        # suite["gpu"][case_short]["CellBased"]["WG64-262144"] = @benchmarkable CellBased($cellinput, $pde, $64, $262144)
        # suite["gpu"][case_short]["CellBased"]["WG128-262144"] = @benchmarkable CellBased($cellinput, $pde, $128, $262144)
        # suite["gpu"][case_short]["CellBased"]["WG512-262144"] = @benchmarkable CellBased($cellinput, $pde, $512, $262144)
        # suite["gpu"][case_short]["CellBased"]["WG32-#cells"] = @benchmarkable CellBased($cellinput, $pde, $32, $length(input.mesh.cells))
        # suite["gpu"][case_short]["CellBased"]["WG64-#cells"] = @benchmarkable CellBased($cellinput, $pde, $64, $length(input.mesh.cells))
        # suite["gpu"][case_short]["CellBased"]["WG128-#cells"] = @benchmarkable CellBased($cellinput, $pde, $128, $length(input.mesh.cells))
        # suite["gpu"][case_short]["CellBased"]["WG512-#cells"] = @benchmarkable CellBased($cellinput, $pde, $512, $length(input.mesh.cells))
        
        # prep = getBatchedFaceBasedGpuInput(input)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG32-8192"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $32, $8192)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG64-8192"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $64, $8192)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG128-8192"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $128, $8192)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG512-8192"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $512, $8192)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG32-16384"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $32, $16384)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG64-16384"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $64, $16384)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG128-16384"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $128, $16384)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG512-16384"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $512, $16384)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG32-32768"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $32, $32768)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG64-32768"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $64, $32768)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG128-32768"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $128, $32768)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG512-32768"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $512, $32768)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG32-65536"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $32, $65536)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG64-65536"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $64, $65536)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG128-65536"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $128, $65536)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG512-65536"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $512, $65536)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG32-131072"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $32, $131072)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG64-131072"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $64, $131072)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG128-131072"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $128, $131072)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG512-131072"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $512, $131072)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG32-262144"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $32, $262144)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG64-262144"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $64, $262144)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG128-262144"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $128, $262144)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG512-262144"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $512, $262144)
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG32-#faces"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $32, $length(input.mesh.faces))
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG64-#faces"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $64, $length(input.mesh.faces))
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG128-#faces"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $128, $length(input.mesh.faces))
        # suite["gpu"][case_short]["batchedFace-Nosplit"]["WG512-#faces"] = @benchmarkable FusedBatchedAssembly2($prep..., $pde, $512, $length(input.mesh.faces))
        
        # facelike = faceLikeInput(input)
        # suite["gpu"][case_short]["batchedFace-split"]["WG32-8192"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $32, $8192)
        # suite["gpu"][case_short]["batchedFace-split"]["WG64-8192"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $8192)
        # suite["gpu"][case_short]["batchedFace-split"]["WG128-8192"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $128, $8192)
        # suite["gpu"][case_short]["batchedFace-split"]["WG512-8192"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $512, $8192)
        # suite["gpu"][case_short]["batchedFace-split"]["WG32-16384"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $32, $16384)
        # suite["gpu"][case_short]["batchedFace-split"]["WG64-16384"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $16384)
        # suite["gpu"][case_short]["batchedFace-split"]["WG128-16384"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $128, $16384)
        # suite["gpu"][case_short]["batchedFace-split"]["WG512-16384"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $512, $16384)
        # suite["gpu"][case_short]["batchedFace-split"]["WG32-32768"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $32, $32768)
        # suite["gpu"][case_short]["batchedFace-split"]["WG64-32768"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $32768)
        # suite["gpu"][case_short]["batchedFace-split"]["WG128-32768"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $128, $32768)
        # suite["gpu"][case_short]["batchedFace-split"]["WG512-32768"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $512, $32768)
        # suite["gpu"][case_short]["batchedFace-split"]["WG32-65536"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $32, $65536)
        # suite["gpu"][case_short]["batchedFace-split"]["WG64-65536"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $65536)
        # suite["gpu"][case_short]["batchedFace-split"]["WG128-65536"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $128, $65536)
        # suite["gpu"][case_short]["batchedFace-split"]["WG512-65536"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $512, $65536)
        # suite["gpu"][case_short]["batchedFace-split"]["WG32-131072"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $32, $131072)
        # suite["gpu"][case_short]["batchedFace-split"]["WG64-131072"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $131072)
        # suite["gpu"][case_short]["batchedFace-split"]["WG128-131072"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $128, $131072)
        # suite["gpu"][case_short]["batchedFace-split"]["WG512-131072"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $512, $131072)
        # suite["gpu"][case_short]["batchedFace-split"]["WG32-262144"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $32, $262144)
        # suite["gpu"][case_short]["batchedFace-split"]["WG64-262144"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $262144)
        # suite["gpu"][case_short]["batchedFace-split"]["WG128-262144"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $128, $262144)
        # suite["gpu"][case_short]["batchedFace-split"]["WG512-262144"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $512, $262144)
        # suite["gpu"][case_short]["batchedFace-split"]["WG32-#faces"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $32, $length(input.mesh.faces))
        # suite["gpu"][case_short]["batchedFace-split"]["WG64-#faces"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $length(input.mesh.faces))
        # suite["gpu"][case_short]["batchedFace-split"]["WG128-#faces"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $128, $length(input.mesh.faces))
        # suite["gpu"][case_short]["batchedFace-split"]["WG512-#faces"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $512, $length(input.mesh.faces))
        # suite["gpu"][case_short]["batchedFace-Split"]["WG64-16384"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $16384)
        # suite["gpu"][case_short]["batchedFace-Split"]["WG64-32768"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $32768)
        # suite["gpu"][case_short]["batchedFace-Split"]["WG64-#faces"] = @benchmarkable FusedBatchedAssembly($facelike..., $pde, $64, $length(input.mesh.faces))
        ...
        # input_facebased = faceInput(input)
        # suite["gpu"][case_short]["faceBased"] = BenchmarkGroup(["gpu", "faceBased", case_short])
        # suite["gpu"][case_short]["faceBased"]["FusedDivLap"] = @benchmarkable FaceAssembly($input_facebased..., $pde)
        # suite["gpu"][case_short]["faceBased"]["DivOnlyPrecalculatedWeightsUpwind"] = @benchmarkable gpu_DivOnlyPrecalculatedWeightsFaceBasedAssemblyRunner($input_facebased..., $wUp)
        # suite["gpu"][case_short]["faceBased"]["DivOnlyPrecalculatedWeightsCDF"] = @benchmarkable gpu_DivOnlyPrecalculatedWeightsFaceBasedAssemblyRunner($input_facebased..., $wCdf)
        # suite["gpu"][case_short]["faceBased"]["PrecalculatedWeightsUpwind"] = @benchmarkable gpu_PrecalculatedWeightsFaceBasedAssemblyRunner($input_facebased..., $wUp)
        # suite["gpu"][case_short]["faceBased"]["PrecalculatedWeightsCDF"] = @benchmarkable gpu_PrecalculatedWeightsFaceBasedAssemblyRunner($input_facebased..., $wCdf)
        # suite["gpu"][case_short]["faceBased"]["LaplaceOnly"] = @benchmarkable gpu_LaplaceOnlyFaceBasedAssemblyRunner($input_facebased...)
        # suite["gpu"][case_short]["faceBased"]["DivOnlyHardCodedUpwind"] = @benchmarkable gpu_DivOnlyHardcodedDivFaceBasedAssemblyRunner($input_facebased..., $"Upwind")
        # suite["gpu"][case_short]["faceBased"]["DivOnlyHardCodedCDF"] = @benchmarkable gpu_DivOnlyHardcodedDivFaceBasedAssemblyRunner($input_facebased..., $"CDF")
        # suite["gpu"][case_short]["faceBased"]["DivOnlyDynamicCDF"] = @benchmarkable gpu_DivOnlyDynamicFaceBasedAssemblyRunner($input_facebased..., $centralDifferencing)
        # suite["gpu"][case_short]["faceBased"]["DivOnlyDynamicUpwind"] = @benchmarkable gpu_DivOnlyDynamicFaceBasedAssemblyRunner($input_facebased..., $upwind)
        # suite["gpu"][case_short]["faceBased"]["HardCodedUpwind"] = @benchmarkable gpu_HardcodedFaceBasedAssemblyRunner($input_facebased..., $"Upwind")
        # suite["gpu"][case_short]["faceBased"]["HardCodedCDF"] = @benchmarkable gpu_HardcodedFaceBasedAssemblyRunner($input_facebased..., $"CDF")
        # suite["gpu"][case_short]["faceBased"]["DynamicCDF"] = @benchmarkable gpu_DynamicFaceBasedAssemblyRunner($input_facebased..., $centralDifferencing)
        # suite["gpu"][case_short]["faceBased"]["DynamicUpwind"] = @benchmarkable gpu_DynamicFaceBasedAssemblyRunner($input_facebased..., $upwind)
    ...
    # end
    results = run(suite, verbose=true)
    processResults(results, "batchedFace.csv", Float64)
    return suite
end


function strongScaling_gpu(i=nothing, T=Float64, case_short="")
    suite = BenchmarkGroup()
    # for (case_path, case_short, case_long) in cases
        suite["gpu"] = BenchmarkGroup(["gpu"])
        println("loading $case_short")
        ...
        # wCdf = CuArray(input.weightsCdf)
        pde = Div{Float64,UpwindScheme{Float64}}(UpwindScheme{Float64}(), 1.0) + Laplace(1.0)
        suite["gpu"][case_short]["batchedFace"] = BenchmarkGroup(["gpu", "batchedFace", case_short])
        # for j in wg
        suite["gpu"][case_short]["batchedFace"]["FusedDivLap-$wg"] = @benchmarkable FusedBatchedAssembly($prep..., $pde, $wg, $25200)
        # end
        # suite["gpu"][case_short]["batchedFace"]["DivOnlyPrecalculatedWeightsUpwind"] = @benchmarkable gpu_DivOnlyPrecalculatedWeightsBatchedFaceAssemblyRunner($prep..., $wUp)
        # suite["gpu"][case_short]["batchedFace"]["DivOnlyPrecalculatedWeightsCDF"] = @benchmarkable gpu_DivOnlyPrecalculatedWeightsBatchedFaceAssemblyRunner($prep..., $wCdf)
        # suite["gpu"][case_short]["batchedFace"]["PrecalculatedWeightsUpwind"] = @benchmarkable gpu_PrecalculatedWeightsBatchedFaceAssemblyRunner($prep..., $wUp)
