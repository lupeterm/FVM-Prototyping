...
function benchmark_case(case::String)
    ...
    # suite["gpu"][case]["batchedFace"]["Fused"] = @benchmarkable gpu_PrecalculatedWeightsBatchedFaceAssemblyRunner($prep..., $wUp)
    # suite["gpu"][case]["batchedFace"]["PrecalculatedWeightsUpwind"] = @benchmarkable gpu_PrecalculatedWeightsBatchedFaceAssemblyRunner($prep..., $wUp)
    # suite["gpu"][case]["batchedFace"]["PrecalculatedWeightsCDF"] = @benchmarkable gpu_PrecalculatedWeightsBatchedFaceAssemblyRunner($prep..., $wCdf)
    # suite["gpu"][case]["batchedFace"]["HardCodedUpwind"] = @benchmarkable gpu_HardcodedBatchedFaceAssemblyRunner($prep..., $"upwind_f")
    # suite["gpu"][case]["batchedFace"]["HardCodedCDF"] = @benchmarkable gpu_HardcodedBatchedFaceAssemblyRunner($prep..., $"CDF")
    # suite["gpu"][case]["batchedFace"]["DynamicCDF"] = @benchmarkable gpu_DynamicBatchedFaceAssemblyRunner($prep..., $cdf_f)
    # suite["gpu"][case]["batchedFace"]["DynamicUpwind"] = @benchmarkable gpu_DynamicBatchedFaceAssemblyRunner($prep..., $upwind_f)
    ...
    # suite["gpu"][case]["cellBased"]["Fused"] = @benchmarkable 
    FusedCell(cellBasedPrep, pde) 
